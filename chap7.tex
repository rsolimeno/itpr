...
Messages are directed throughout the worldwide BBS\index{BBS} network using a scheme called HIERARCHICAL\index{hierarchical addressing} ADDRESSING. The format for a hierarchical address is:\\
