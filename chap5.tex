...
Now let's go through the basic procedures you should follow when checking into a BBS.\index{BBS} After you connect and receive the welcome message, you will receive a list of your mail\index{mail list} if there are any personal messages addressed to your callsign. Enter the command \verb!RN!\index{RN command} to read your mail. If that command isn't available, note the message numbers and then enter: \verb!R!\index{R command} followed by the message numbers, separating each by a space. Example:
